...
{
    GTFSStop *stopRecord = [[GTFSStop alloc] init];
...
- (void)updateRoutes
{
    @autoreleasepool {
        ...
        GTFSRoute *route = [[GTFSRoute alloc] init];
        NSArray *routeArray = [route getAllRoutes];
        GTFSStopTime *stopTime = [[GTFSStopTime alloc] init];
...
+ (NSArray *)getAllStops
{
    ...
    FMDatabase *localdb = [FMDatabase databaseWithPath:[GTFSDatabase autoUpdateDatabasePath]];
