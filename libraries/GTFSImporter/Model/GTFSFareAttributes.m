...
@implementation GTFSFareAttributes
...
- (void)addFareAttributesObject:(GTFSFareAttributes *)value {
    if (db==nil) {
...
{
    GTFSFareAttributes *fareAttributesRecord = [[GTFSFareAttributes alloc] init];
